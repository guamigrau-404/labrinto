...
procedure IrPara(cX, cY: integer);
begin
...
begin
  ...
  // 2. Linhas Horizontais (Superior e Inferior)
  for iX := 2 to 21 do
  begin
    gotoxy(iX, 1);   write(#205); { - }
    gotoxy(iX, 12);  write(#205); { - }
  end;

  // 3. Linhas Verticais (Laterais)
  for iY := 2 to 11 do
  begin
    gotoxy(1, iY);   write(#186); { ¦ }
    gotoxy(22, iY);  write(#186); { ¦ }
  end;
end;
